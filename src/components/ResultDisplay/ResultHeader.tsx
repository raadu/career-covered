...
const ResultHeader = ({
  ...
  return (
    <div className="bg-gradient-to-r from-blue-50/50 to-indigo-50/50 dark:from-blue-900/30 dark:to-indigo-900/30 p-2.5 md:p-5 border-b border-blue-100 dark:border-blue-800 flex flex-col sm:flex-row items-center justify-between gap-2 sm:gap-4">
      <h3 className="font-bold text-blue-900 dark:text-blue-200 tracking-tight text-xs sm:text-sm md:text-base">Generated Cover Letter</h3>
      <div className="flex items-center justify-center sm:justify-end gap-1.5 sm:gap-2 w-full sm:w-auto overflow-x-auto no-scrollbar">
        <CommonButton
          ...
          icon={isDownloading !== "pdf" && <FaFilePdf className="text-rose-500" size={14} />}
        ...
        <CommonButton
          ...
          disabled={!!isDownloading}
          icon={isDownloading !== "word" && <FaFileWord className="text-blue-500" size={14} />}
        ...
        <CommonButton
          ...
          onClick={handleCopy}
          icon={copied ? <LuCheck className="text-green-500" size={14} /> : <LuCopy size={14} />}
