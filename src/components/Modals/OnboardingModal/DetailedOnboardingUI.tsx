    ...
    <div className="text-left space-y-3 animate-in fade-in slide-in-from-right-4 duration-300">
      ...
      <div className="space-y-3">
        <div className="bg-blue-50/50 p-3 rounded-xl border border-blue-100/50">
          <h2 className="text-[13px] font-bold text-blue-900 mb-0.5">
        ...
        <div className="space-y-2">
          ...
          <div className="space-y-2 text-[14px] text-gray-600 leading-relaxed">
            <div className="flex gap-4 items-start">
              <div className="flex-shrink-0 w-6 h-6 rounded-full bg-gray-100 text-gray-500 flex items-center justify-center text-[11px] font-bold mt-0.5">
                1
              </div>
