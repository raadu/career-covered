      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl sm:rounded-3xl shadow-sm border border-gray-100 dark:border-gray-700 p-5 sm:p-8 md:p-12 text-center space-y-8 sm:space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          >
            ...
            <span className="font-bold text-blue-900 group-hover:text-white text-sm sm:text-lg">
              Connect on LinkedIn
            </span>
          </a>
        </div>
        ...
        <div className="relative">
          ...
          <div className="relative flex justify-center">
            <span className="bg-white dark:bg-gray-800 px-4 text-sm text-gray-300 dark:text-gray-500 font-medium italic">
              or help me improve
            </span>
          </div>
        </div>
        ...
        <div className="space-y-8">
          ...
          >
            ...
            <span className="text-[11px] sm:text-sm font-black uppercase tracking-widest text-gray-400 dark:text-gray-500 group-hover:text-orange-600 dark:group-hover:text-orange-400 transition-colors">
              Feedback Form
            </span>
          </a>
        </div>
