  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta
          name="description"
          content="100% free cover letters. No payments needed. Create cover letters in 2 seconds. Cover letters based on job description and your template."
        />
        ...
        <meta
          property="og:title"
          content="Career Covered | Free AI Cover Letter Generator"
        />
        <meta
          property="og:description"
          content="Generate professional, tailored cover letters in seconds for free. No account required, no hidden costs."
        />
        <meta
          property="og:image"
          content={`https://careercovered.com${ogImage}`}
        />
